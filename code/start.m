% Run this file to play gameCode.m
...
% Last Modified by GUIDE v2.5 09-Dec-2019 11:54:32
...
% Images added to background:

% Add image of large asteroid
axes(handles.axes1)
matlabImage = imread('Ast1.png');
image(matlabImage)
axis off
axis image

% Add image of medium-sized asteroid
axes(handles.axes3)
matlabImage = imread('Ast2.png');
image(matlabImage)
axis off
axis image

% Add image of small asteroid
axes(handles.axes4)
matlabImage = imread('Ast3.png');
image(matlabImage)
axis off
axis image
